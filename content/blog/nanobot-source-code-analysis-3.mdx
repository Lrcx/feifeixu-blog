---
title: "nanobot 源码解析（三）：Markdown 驱动的系统提示词"
date: "2026-03-10"
excerpt: "为什么 nanobot 的 Agent 感觉更有“人味”？本文带你深入 ContextBuilder 的源码，揭秘如何通过 Markdown 文件（SOUL.md, USER.md）和运行时上下文注入，构建AI 助手系统提示词"
tags: ["agent", "nanobot"]
category: "技术分享"
author: "肥肥旭"
---
...
![img_11.png](/blog-images/nanobot-source-code-analysis-3/img-11.png)

nanobot内置skills，这些skills存放在项目根目录/nanobot/skills文件夹中：

![img_10.png](/blog-images/nanobot-source-code-analysis-3/img-10.png)
