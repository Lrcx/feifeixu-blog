---
title: "nanobot 源码解析（一）：环境搭建、Debug 配置与 onboard 命令详解"
date: "2026-03-09"
excerpt: "想要深入理解 AI Agent？先从跑通 nanobot 开始。本文带你完成环境搭建，拆解核心命令，并揭秘命令注册背后的技术细节。"
tags: ["agent", "nanobot"]
category: "技术分享"
author: "肥肥旭"
---
...
![图：nanobot: onboard 配置示例](/blog-images/nanobot-source-code-analysis-1/img.png)

图：nanobot: onboard 配置示例

![图：nanobot: agent 配置示例](/blog-images/nanobot-source-code-analysis-1/img-3.png)

图：nanobot: agent 配置示例

![图：nanobot: gateway 配置示例](/blog-images/nanobot-source-code-analysis-1/img-2.png)
