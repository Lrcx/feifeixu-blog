...
const timeline = [
  {
    year: "2025 至今",
    title: "智慧养老 AI 与算法基建",
    desc: "围绕陪伴式 AI、K3s 集群、GPU 资源调度和基础模型服务矩阵，推进大模型能力在真实业务中的稳定运行。",
  },
  {
    year: "2023 - 2025",
    title: "金融与办公场景 LLM 应用",
    desc: "落地智能客服、办公问答助手等项目，持续实践 RAG、Agent、向量召回、Prompt Engineering 和结构化输出。",
  },
  {
    year: "2020 - 2023",
    title: "研究生阶段：计算机技术",
    desc: "攻读计算机技术方向硕士，系统训练算法工程、软件系统与工程实践能力，并逐步将研究和项目兴趣聚焦到 AI 应用落地。",
  },
  {
    year: "2016 - 2020",
    title: "本科阶段：计算机科学与技术",
    desc: "完成计算机科学与技术本科训练，从编程、数据结构、系统基础到项目实践建立工程思维，也开启了持续写作和技术探索的习惯。",
  },
];
